...
Phạm vi: `nhom-c1/codebase/`, `nhom-c1/eval/`, `eval/` và `spec.md` ở gốc repo.
...
- `nhom-c1/eval/golden_set.json` giữ bộ 28 case của pipeline.
- 10/28 case được liên hệ với dữ liệu thật trong data pack của chương trình.
- `nhom-c1/codebase/fixtures/qa-cases.json` có 10 case QA tổng hợp.
...
- `nhom-c1/eval/run_results.*` lưu lượt eval `openai` 26/28 hiện tại.
